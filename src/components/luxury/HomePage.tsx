          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
            {categories.map((cat, index) => {
              const catImages = [
                ...
                'https://images.unsplash.com/photo-1637888368690-4a669a5532e9?w=400',
                'https://images.unsplash.com/photo-1627123424574-724758594e93?w=400',
                'https://images.unsplash.com/photo-1601924994987-69e26d50dc64?w=400',
      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { icon: Truck, title: 'Free Shipping', desc: 'Complimentary worldwide delivery on orders over $1,000' },
